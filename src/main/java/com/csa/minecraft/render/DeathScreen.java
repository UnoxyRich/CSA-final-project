...
public class DeathScreen {
    ...
    public DeathScreen(Settings settings) {
    ...
    public Action update(int viewW, int viewH, double cursorPx, double cursorPy, boolean clicked) {
        ...
        int reviveY = panelY + s(126);
        int quitY = reviveY + btnH + s(16);

        if (in(cursorPx, cursorPy, btnX, reviveY, btnW, btnH)) return Action.REVIVE_AND_RESET;
    ...
    public void render(HudRenderer hud, int viewW, int viewH) {
        ...
        hud.rectPx(0, 0, viewW, viewH, 0.30f, 0.02f, 0.02f, 0.72f);
        ...
        hud.rectPx(panelX, panelY, panelW, panelH, 0.08f, 0.07f, 0.075f, 0.96f);
        outline(hud, panelX, panelY, panelW, panelH, s(2), 0.95f, 0.95f, 0.95f, 0.95f);

        drawCentered(hud, "YOU DIED", panelX, panelW, panelY + s(28), titleScale,
                     0.95f, 0.12f, 0.12f, 1f);
        drawCentered(hud, "YOUR WORLD CAN BE RESET", panelX, panelW, panelY + s(84), textScale,
                     1f, 1f, 1f, 0.9f);
        ...
        drawButton(hud, btnX, reviveY, btnW, btnH, "REVIVE + RESET", 0.22f, 0.42f, 0.24f, textScale);
